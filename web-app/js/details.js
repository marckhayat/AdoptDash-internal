...
function renderDetails(data) {
  ...
  html += '<div class="form-check form-check-sm"><input class="form-check-input" type="checkbox" id="filter-uc2550"><label class="form-check-label" for="filter-uc2550">UC 25-50% eligible w/o opt-in</label></div>';
  html += '<div class="form-check form-check-sm"><input class="form-check-input" type="checkbox" id="filter-uc75"><label class="form-check-label" for="filter-uc75">UC 75% eligible w/o opt-in</label></div>';
